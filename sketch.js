...
function drawDebugPanel() {
  ...
  let buttons = [
    { label: "S:Start", x: 12 },
    { label: "O:GameOver", x: 108 },
    { label: "W:Win", x: 204 },
    { label: "1:Level 1", x: 300 },
    { label: "2:Level 2", x: 396 },
    { label: "3:Level 3", x: 492 },
  ];
...
// ------------------------------------------------------------
// keyPressed()
// Debug shortcuts — D toggles panel, S/O/W/1/2/3 jump around.
// ------------------------------------------------------------
function keyPressed() {
  if (key === "d" || key === "D") {
    debugMode = !debugMode;
